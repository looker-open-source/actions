                ...
                if (url) {
                    ...
                    httpRequest
                        ...
                        if (response.statusCode !== 200) {
                            winston.warn(`[stream] There was an error received from Looker.`, this.logInfo);
                            winston.warn(`[stream] ErrorCode: ${response.statusCode} ErrorMessage: ${response.statusMessage}`);
                            if (!hasResolved) {
