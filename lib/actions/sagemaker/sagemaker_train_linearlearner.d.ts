...
export declare class SageMakerTrainLinearLearnerAction extends Hub.Action {
    name: string;
    label: string;
    iconName: string;
    description: string;
    ...
    protected getSageMakerClientFromRequest(request: Hub.ActionRequest, region: string): SageMaker;
