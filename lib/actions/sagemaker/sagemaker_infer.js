...
class SageMakerInferAction extends Hub.Action {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.uploadToS3(request, bucket, numStripColumns, inputDataKey, rawDataKey);
                ...
                const transformResponse = yield client.createTransformJob(transformParams).promise();
    ...
    form(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const models = yield this.listModels(request);
    ...
    listModels(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield sagemaker.listModels().promise();
            return response.Models;
        });
    }
    uploadToS3(request, bucket, numStripColumns, inputDataKey, rawDataKey) {
        return __awaiter(this, void 0, void 0, function* () {
