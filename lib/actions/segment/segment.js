...
class SegmentAction extends Hub.Action {
    ...
    async executeSegment(request, segmentCall) {
        ...
        try {
            await request.streamJsonDetail({
                ...
                onRow: (row) => {
                    this.unassignedSegmentFieldsCheck(segmentFields);
                    const payload = {
                        ...this.prepareSegmentTraitsFromRow(row, fieldset, segmentFields, hiddenFields, segmentCall === SegmentCalls.Track, segmentCall === SegmentCalls.Group),
