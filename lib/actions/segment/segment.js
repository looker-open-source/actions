...
class SegmentAction extends Hub.Action {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield request.streamJsonDetail({
                    ...
                    onRow: (row) => {
                        this.unassignedSegmentFieldsCheck(segmentFields);
                        const payload = Object.assign(Object.assign({}, this.prepareSegmentTraitsFromRow(row, fieldset, segmentFields, hiddenFields, segmentCall === SegmentCalls.Track)), { event, context, timestamp });
    ...
    prepareSegmentTraitsFromRow(row, fields, segmentFields, hiddenFields, trackCall) {
        const traits = {};
