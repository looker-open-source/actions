...
class AugerTrainAction extends Hub.Action {
    ...
    async validateAugerToken(token) {
        try {
    ...
    async getProjectFileURL(projectName, filePath, token) {
        try {
            const options = {
    ...
    async chunkToS3(fileInfo, transaction) {
    ...
    async processStream(request, transaction) {
    ...
    async startProject(transaction) {
        try {
            const options = {
                method: "PATCH",
    ...
    async startProjectFile(transaction) {
    ...
    async startExperiment(transaction) {
    ...
    async createProjectFile(transaction) {
        try {
            const projOptions = {
    ...
    async createExperiment(transaction) {
        try {
            const options = {
    ...
    async getProjectFile(transaction) {
        try {
            const options = {
    ...
    async startSession(transaction) {
        try {
            const options = {
