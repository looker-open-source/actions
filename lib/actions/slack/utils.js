...
const usableChannels = (slack) => __awaiter(void 0, void 0, void 0, function* () {
    let channels = yield _usableChannels(slack);
    channels = channels.concat(yield usableDMs(slack));
    channels.sort((a, b) => ((a.label < b.label) ? -1 : 1));
    return channels;
});
exports.getDisplayedFormFields = (slack) => __awaiter(void 0, void 0, void 0, function* () {
    const channels = yield usableChannels(slack);
    return [
        {
