...
exports.displayError = exports.handleExecute = exports.getDisplayedFormFields = exports.setErrorResponse = exports.API_LIMIT_SIZE = void 0;
...
const setErrorResponse = (error) => {
    const errorMessage = {
        http_code: http_errors_1.HTTP_ERROR.internal.code,
        status_code: http_errors_1.HTTP_ERROR.internal.status,
        location: "slack",
        message: http_errors_1.HTTP_ERROR.internal.description,
        documentation_url: "TODO",
    };
    if (error.code === web_api_1.ErrorCode.PlatformError) {
        errorMessage.http_code = http_errors_1.HTTP_ERROR.internal.code;
        ...
        errorMessage.http_code = http_errors_1.HTTP_ERROR.bad_request.code;
        errorMessage.status_code = http_errors_1.HTTP_ERROR.bad_request.status;
        ...
        errorMessage.http_code = http_errors_1.HTTP_ERROR.resource_exhausted.code;
        errorMessage.status_code = http_errors_1.HTTP_ERROR.resource_exhausted.status;
        errorMessage.message = `Slack errored with RateLimitedError`;
    }
    else if (error.code === web_api_1.ErrorCode.FileUploadInvalidArgumentsError) {
        errorMessage.http_code = http_errors_1.HTTP_ERROR.invalid_argument.code;
        errorMessage.status_code = http_errors_1.HTTP_ERROR.invalid_argument.status;
...
const handleExecute = (request, slack) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!request.formParams.channel) {
        const error = {
            ...
            message: `${http_errors_1.HTTP_ERROR.bad_request.description} ${LOG_PREFIX} Missing channel`,
    ...
    try {
        ...
        const err = (0, exports.setErrorResponse)(e);
        response.error = err;
        response.webhookId = request.webhookId;
        response.success = false;
