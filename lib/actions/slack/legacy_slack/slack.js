...
https://github.com/looker/actions/blob/master/src/actions/slack/legacy_slack/README.md`,
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield utils_1.handleExecute(request, this.slackClientFromRequest(request));
        });
    }
    form(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const channelType = _.isNil(request.formParams.channelType) || request.formParams.channelType === "channels"
                ? "channels" : "users";
            try {
                form.fields = yield utils_1.getDisplayedFormFields(this.slackClientFromRequest(request), channelType);
            }
            catch (e) {
    ...
    slackClientFromRequest(request) {
        return new client_1.WebClient(request.params.slack_api_token);
    }
}
