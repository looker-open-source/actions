    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!selectedClient) {
                ...
                return yield utils_1.handleExecute(request, selectedClient);
            }
        });
    }
    form(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (slack_client_manager_1.isSupportMultiWorkspaces(request) && clientManager.hasAnyClients()) {
                try {
            ...
            const channelType = _.isNil(request.formParams.channelType) || request.formParams.channelType === "channels"
                ? "channels" : "users";
            try {
                form.fields = form.fields.concat(yield utils_1.getDisplayedFormFields(client, channelType));
            }
            catch (e) {
                return this.loginForm(request, form);
            }
    ...
    oauthCheck(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const valFn = (resp) => slack_client_manager_1.isSupportMultiWorkspaces(request) ?
