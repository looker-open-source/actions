...
exports.isSupportMultiWorkspaces = (request) => request.lookerVersion && semver.gte(request.lookerVersion, exports.MULTI_WORKSPACE_SUPPORTED_VERSION);
exports.makeSlackClient = (token) => new web_api_1.WebClient(token);
            ...
            if (supportMultiWs && Array.isArray(json)) {
                this.clients = JSON.parse(stateJson)
                    ...
                    if (stateJsonItem.token) {
                        accumulator[ws] = exports.makeSlackClient(stateJsonItem.token);
                    }
                    return accumulator;
                }, {});
                ...
                this.clients = { [exports.PLACEHOLDER_WORKSPACE]: exports.makeSlackClient(stateJson) };
            }
        }
    }
}
