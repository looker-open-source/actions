...
class GoogleAdsCustomerMatch extends Hub.OAuthAction {
    ...
    async form(hubReq) {
        ...
        try {
            ...
            const isAuthError = ((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) === 401 ||
                err.code === "401" ||
                err.code === 401 ||
                (((_b = err.response) === null || _b === void 0 ? void 0 : _b.status) === 400 && ((_d = (_c = err.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.error) === "invalid_grant");
            if (isAuthError) {
