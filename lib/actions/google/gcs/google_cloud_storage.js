        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let error = {
                    ...
                    message: `${http_errors_1.HTTP_ERROR.internal.description} ${LOG_PREFIX}`,
                    location: "GCS",
                    documentation_url: "TODO",
                };
                if (e.code) {
                    const formattedError = (0, utils_1.formatErrorCode)(e.code);
                    error = Object.assign(Object.assign({}, error), { http_code: formattedError.code, status_code: formattedError.status, message: `${formattedError.description} ${LOG_PREFIX} ${e.message}` });
                }
                response.success = false;
                response.error = error;
                response.message = error.message;
