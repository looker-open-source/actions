    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (stateJson.tokens && stateJson.redirect) {
                ...
                if (!filename) {
                    const error = (0, action_response_1.errorWith)(http_errors_1.HTTP_ERROR.bad_request, `${LOG_PREFIX} ${http_errors_1.HTTP_ERROR.bad_request.description} Error creating filename from request`);
                    resp.success = false;
                    resp.error = error;
