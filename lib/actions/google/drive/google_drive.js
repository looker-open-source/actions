...
class GoogleDriveAction extends Hub.OAuthAction {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (stateJson.tokens && stateJson.redirect) {
                if (request.params.domain_allowlist) {
                    const domainCheck = yield this.checkDomain(stateJson.redirect, stateJson.tokens, request.params.domain_allowlist);
                    if (domainCheck) {
    ...
    checkDomain(redirect, tokens, domainCSVString) {
        return __awaiter(this, void 0, void 0, function* () {
            const domainList = domainCSVString.split(",").map(domain => domain.trim());
            const client = this.oauth2Client(redirect);
            client.setCredentials(tokens);
