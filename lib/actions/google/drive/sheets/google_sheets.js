...
const RETRY_BASE_DELAY = process.env.GOOGLE_SHEETS_BASE_DELAY ? Number(process.env.GOOGLE_SHEETS_WRITE_BATCH) : 3;
...
class GoogleSheetsAction extends google_drive_1.GoogleDriveAction {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (stateJson.tokens && stateJson.redirect) {
                ...
                try {
                    ...
                    let error = Hub.errorWith(http_errors_1.HTTP_ERROR.internal, ` ${LOG_PREFIX} Failed execute. Error: ${e.toString()}`);
                    if (e.code && e.errors && e.errors[0] && e.errors[0].message) {
                        error = Object.assign(Object.assign({}, error), { http_code: e.code, message: `${LOG_PREFIX} ${http_errors_1.HTTP_ERROR.internal.description} ${e.errors[0].message}` });
                    }
                    resp.success = false;
    ...
    sendOverwriteData(filename, request, drive, sheet) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const files = yield drive.files.list(options).catch((e) => {
                this.sanitizeGaxiosError(e);
                winston.debug(`Error listing drives. Error ${e.toString()}`, { webhookId: request.webhookId });
                throw e;
            });
            ...
            const sheets = yield this.retriableSpreadsheetGet(spreadsheetId, sheet, 0, request.webhookId).catch((e) => {
                this.sanitizeGaxiosError(e);
