                        ...
                        csvparser.on("data", (line) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (requestBody.requests.length > MAX_REQUEST_BATCH) {
                                ...
                                if (rowCount >= maxRows) {
                                    ...
                                    yield this.retriableResize(maxRows, sheet, spreadsheetId, sheetId, 0, request.webhookId)
                                        .catch((e) => {
                                        this.sanitizeGaxiosError(e);
                                ...
                                yield this.flush(requestCopy, sheet, spreadsheetId, request.webhookId).catch((e) => {
                                    this.sanitizeGaxiosError(e);
                            ...
                            if (requestBody.requests.length > 0) {
                                ...
                                yield this.flush(requestBody, sheet, spreadsheetId, request.webhookId).then(() => {
