            ...
            if (stateJson.tokens && stateJson.redirect) {
                ...
                if (!filename) {
                    const error = {
                        ...
                        message: `${http_errors_1.HTTP_ERROR.bad_request.description} Error creating file name`,
                ...
                try {
                    ...
                    let error = Hub.errorWith(http_errors_1.HTTP_ERROR.internal, `Failed execute for Google Sheets. Error: ${e.toString()}`);
