    ...
    it("works with segment_group_id", () => {
      ...
      request.attachment = {
        dataBuffer: Buffer.from(
          JSON.stringify({
            fields: {
              dimensions: [{ name: "coolfield", tags: ["segment_group_id"] }],
            },
      ...
      request.attachment = {
        dataBuffer: Buffer.from(
          JSON.stringify({
            ...
            data: [
              { coolfield: { value: "funvalue" }, coolid: { value: "id" } },
            ],
          })
        ),
      };
      ...
      request.attachment = {
        dataBuffer: Buffer.from(
          JSON.stringify({
            ...
            data: [
              { coolfield: { value: "funvalue" }, coolid: { value: null } },
            ],
          })
        ),
      };
      ...
      request.attachment = {
        dataBuffer: Buffer.from(
          JSON.stringify({
            ...
            data: [
              { coolfield: { value: "funvalue" }, zerofield: { value: 0 } },
            ],
          })
        ),
      };
