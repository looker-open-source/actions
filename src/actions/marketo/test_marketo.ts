  ...
  describe(`${action.constructor.name} unit tests`, () => {
    describe("action", () => {
      ...
      it("sends all the data to Marketo for 'addList' subaction", () => {
        ...
        request.formParams = {
          subaction: "addList",
          campaignId: "303", // Yes, we are using the name campaignId to hold list Ids. See JIRA DD-470
          lookupField: "email",
        }
      ...
      it("sends all the data to Marketo for 'removeList' subaction", () => {
        ...
        request.formParams = {
          ...
          campaignId: "404", // Yes, we are using the name campaignId to hold list Ids. See JIRA DD-470
          lookupField: "email",
        }
